...
We need to keep track of when players discover new locations. 
However, there's a bug in the updateLocationById() function. 
It looks like the location's discovered property isn't getting saved properly by the server.
